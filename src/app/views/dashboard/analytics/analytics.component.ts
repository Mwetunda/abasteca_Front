...
export class AnalyticsComponent implements OnInit, OnDestroy {
  ...
  getMetricas_Tesouraria(utilizador: any) {
    // if (this.Menu_Tesouraria) {
    //   this.dashboardService.metricas_tesouraria_totais(utilizador).subscribe((m) => {
    //     const resultado = m.objecto;
    //     this.tesouraria.totais = resultado.totais;
    //     this.tesouraria.tiposBancos = resultado.tiposBancos;
    //   });

    //   this.dashboardService.metricas_tesouraria_grafico(utilizador)
    //     .subscribe((m) => {
    //       const grafico = m.objecto;
    //       console.log("TE GRAfico",m);
    //     });
    // }
  }
  ...
  setChartColor(theme) {
    this.lineChartColors = [
      {
        backgroundColor: tinyColor(theme.baseColor).setAlpha(0.6),
        borderColor: "rgba(0,0,0,0)",
        pointBackgroundColor: tinyColor(theme.baseColor).setAlpha(0.4),
        pointBorderColor: "rgba(0, 0, 0, 0)",
        pointHoverBackgroundColor: theme.baseColor,
        pointHoverBorderColor: theme.baseColor,
      },
      {
        backgroundColor: "rgba(41,12,154,0.08)",
        borderColor: "rgba(0,0,0,0)",
